...
export function UserBadge({ displayName, avatarEmoji, onProfileClick }: UserBadgeProps) {
  return (
    <button
    ...
    >
      {avatarEmoji ? (
        <span className="w-[18px] h-[18px] flex items-center justify-center text-[15px] leading-none">
          {avatarEmoji}
        </span>
      ) : (
