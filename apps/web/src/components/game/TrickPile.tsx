...
export function TrickPile({ cards, players, currentPlayerId, marriageCard, isSpectating }: TrickPileProps) {
  ...
  return (
    <div className={cn(
      ...
      {/* Gold glow when marriage declared — lightweight CSS animation */}
      {marriageCard && (
        <div
          className="absolute inset-2 rounded-full pointer-events-none"
          style={{
            background: 'radial-gradient(circle, rgba(212, 175, 55, 0.4) 0%, rgba(245, 231, 163, 0.2) 40%, transparent 70%)',
            boxShadow: '0 0 25px 8px rgba(212, 175, 55, 0.35), inset 0 0 20px 4px rgba(245, 231, 163, 0.15)',
            animation: 'marriageGlow 2s ease-in-out infinite',
          }}
        />
      )}
